    ...
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-[2rem] border border-border bg-white shadow-sm hover:shadow-md transition-all duration-300">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(rgba(13,143,122,0.12) 1px, transparent 1px), linear-gradient(90deg, rgba(13,143,122,0.12) 1px, transparent 1px)",
              ...
              {requests.map((req, i) => (
                ...
                >
                  <div className="relative">
                    ...
                    <div className="absolute -top-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-xl bg-white/95 backdrop-blur-xs px-3 py-1 text-xs font-semibold text-foreground shadow-md border border-border">
                      {req.patientName}
                    </div>
        ...
        {/* Map overlay badge */}
        <div className="absolute left-4 top-4 flex items-center gap-2 rounded-xl border border-border bg-white/95 px-3.5 py-2 text-xs font-semibold text-foreground shadow-xs backdrop-blur-sm">
            ...
            {requests.map((req, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    {req.etaMinutes != null && (
                      <span className="text-sm font-semibold text-accent bg-accent-soft px-3 py-1 rounded-xl border border-accent/20">
